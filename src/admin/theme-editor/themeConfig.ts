...
export function createThemeConfigFromCmsState(state: CmsState): StorefrontThemeConfig {
  ...
  const homeSections: ThemeEditorSection[] = [
      ...
      }),
      {
        ...
        overlayDarkness: state.hero.overlayDarkness ?? 0.55,
  ...
  return {
    ...
    theme: {
      ...
      primaryColor: state.brand.primaryColor || "#0369A1",
      secondaryColor: state.brand.ctaColor || "#10B981",
      backgroundColor: state.brand.bgColor || "#F8F9FA",
      textColor: state.brand.textColor || "#111111",
      accentColor: state.brand.primaryColor || "#0369A1",
      radius: "large",
      stylePreset: "premium",
      colorPreset: "default",
      pageWidth: "1200px",
  ...
  return {
    ...
    hero: hero
      ? {
          ...
          overlayDarkness: hero.settings.overlayDarkness ?? state.hero.overlayDarkness,
