...
export const seed: CmsState = {
  ...
  products: [
    ...
    },
    {
      ...
      title: "فلتر ماء الصنبور الذكي",
      shortDescription: "خلي ماء الروبيني يولي أحسن فالمذاق والريحة بلا بلومبي وبلا صناع القراعي.",
      longDescription: "فلتر عملي كيركب فدقائق وكينقص ريحة الكلور ويصفي الشوائب والترسبات باش تشرب ماء نقي وصافي.",
      price: 159,
      compareAtPrice: 299,
      images: [
        "/images/water-filter/hero.png",
        "/images/water-filter/solution.png",
        "/images/water-filter/mechanism.png",
        "/images/water-filter/package.png",
      ],
      categoryId: "cat-home",
      badge: "تصفية نقية",
      featured: true,
      hidden: false,
      stock: "low",
      guarantee: "ضمان التوافق التام",
      codNote: "الدفع عند الاستلام • شوف الطرد قبل ما تخلص • تأكيد قبل الشحن.",
      features: [
    ...
    },
    {
      ...
      shortDescription: "منظم حمام كيتركب فالحائط بلا حفير، فيه 3 كيسان مقلوبة، موزع سينيال، بلاصة للفرش، ورف علوي.",
      longDescription: "حوّل حمامك الصغير لحمام متول ونقي بلا حفير فالزليج. منظم حمام ذكي فيه 3 كيسان، موزع سينيال، رف عملي، وبلاصة للفرش. كيجمع الروينة ديال اللافابو فبلاصة وحدة، وكيتركب فالحائط بلا شنيور ولا صداع.",
      price: 199,
      compareAtPrice: 299,
      images: [
        "/images/organizer/hero.png",
        "/images/organizer/solution.png",
        "/images/organizer/details.png",
        "/images/organizer/offer.png",
      ],
      categoryId: "cat-home",
      badge: "الأكثر مبيعاً",
      featured: true,
      hidden: false,
      stock: "low",
      guarantee: "شوف الطرد قبل ما تخلص",
      codNote: "الدفع عند الاستلام • شوف الطرد قبل ما تخلص • تأكيد قبل الشحن.",
      features: [
  ...
  landingPages: [
    ...
    },
    {
      productId: "p-org-1",
      slug: "bathroom-organizer",
      badge: "المنظم الأكثر مبيعا 🧼",
      headline: "حوّل حمامك الصغير",
      subheadline: "لحمام متول بلا حفير",
      description: "منظم حمام ذكي فيه 3 كيسان، موزع سينيال، رف عملي، وبلاصة للفرش. كيجمع الروينة ديال اللافابو فبلاصة وحدة، وكيتركب بلا شنيور.",
      features: [
        { icon: "🥛", text: "3 كيسان مقلوبة" },
        { icon: "🪥", text: "موزع السينيال" },
        { icon: "🔧", text: "بلا شنيور أو حفير" },
      ...
      primaryCta: "أضف للسلة",
      secondaryCta: "اطلب دابا",
      guarantee: "الدفع عند الاستلام • شوف الطرد قبل ما تخلص • تأكيد قبل الشحن",
      urgencyText: "⚡ الدفعة الحالية محدودة",
    },
    {
      productId: "p-wf1",
      slug: "tap-water-filter",
      badge: "تصفية نقية 💧",
      headline: "خلي ماء الروبيني يولي أحسن فالمذاق والريحة",
      subheadline: "بلا بلومبي وبلا صناع القراعي",
      description: "فلتر عملي كيركب فدقائق وكينقص ريحة الكلور والشوائب باش تشرب ماء نقي وصافي مباشرة من الصنبور.",
      features: [
        { icon: "⚡", text: "تركيب بلا حفير" },
        { icon: "💧", text: "يصفي الكلور" },
        { icon: "🥛", text: "مذاق طبيعي نقي" },
      ...
      secondaryCta: "اطلب دابا",
      guarantee: "الدفع عند الاستلام • شوف الطرد قبل ما تخلص • تأكيد قبل الشحن",
      urgencyText: "⚡ الكمية المتوفرة محدودة لهاد الأسبوع",
    },
  ],
};
